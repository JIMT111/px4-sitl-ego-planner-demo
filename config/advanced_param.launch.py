...
def generate_launch_description():
    ...
    obstacles_inflation_arg = DeclareLaunchArgument('obstacles_inflation', default_value=obstacles_inflation, description='Inflated obstacle radius in meters')
    lambda_fitness_arg = DeclareLaunchArgument('lambda_fitness', default_value=lambda_fitness, description='Trajectory fitting weight after rebound search')
